...
[![View Dashboard PDF](dashboard-overview.pdf)](dashboard-overview.pdf)

> 💡 *Click the preview above to view or download the full [Dashboard Specification / Report (PDF)](dashboard-overview.pdf).*
